...
namespace MVoxelizer
{
    public class MeshVoxelizerEditor : MeshVoxelizer
    {
        ...
        public void ApplySetting(MeshVoxelizerSetting setting)
        {
            ...
            ignoreScaling       = setting.ignoreScaling;
            alphaCutout         = setting.alphaCutout;
            CutoffValue         = setting.CutoffValue;
        ...
        public override GameObject VoxelizeMesh()
        {
            ...
            if (go != null)
            {
                ...
                if (!ignoreScaling) go.transform.localScale = sourceGameObject.transform.localScale;
        ...
        public override GameObject GenerateResult()
        {
            ...
            if (!compactOutput)
            {
                ...
                string guid = AssetDatabase.CreateFolder("Assets/MeshVoxelizer/Temp", tempPath);
                folderPath = AssetDatabase.GUIDToAssetPath(guid);
            }
            ...
            GameObject go = new GameObject(assetName + " Voxelized");
...
#endif
                Undo.RecordObject(sourceGameObject, "Voxelize mesh");
